const IMAGE_BASE_URL = window.BACKEND_BASE_URL || '';
        ...
        const cardHtml = `
            <div class="book-card">
                <div class="book-img-wrapper">
                    <img src="${IMAGE_BASE_URL}/images/${img}" alt="${book.title}" class="book-img">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderCartUI(cart, totalPrice, totalItems) {
        ...
        cart.forEach(item => {
            ...
            html += `
            <div class="cart-item">
                <img src="${IMAGE_BASE_URL}/images/${item.img}" alt="${item.title}">
